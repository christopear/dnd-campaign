...
class Dragonborn(Person):
    ...
    def nameFem(self):
        name_component = choice(Dragonborn.nm3)
        name_component2 = choice(Dragonborn.nm4)
        nMs = name_component + name_component2
        return testSwear(nMs)


    def nameMas(self):
        name_component = choice(Dragonborn.nm1)
        name_component2 = choice(Dragonborn.nm2)
        nMs = name_component + name_component2
        return testSwear(nMs)


    def nameSur(self):
        name_component = choice(Dragonborn.nm5)
        name_component2 = choice(Dragonborn.nm6)
        name_component3 = choice(Dragonborn.nm7)
        name_component4 = choice(Dragonborn.nm6)
        name_component5 = choice(Dragonborn.nm10)
        ...
        if i < 4:
            ...
            name_component6 = choice(Dragonborn.nm6)
            name_component7 = choice(Dragonborn.nm8)
            ...
            if i < 7:
                ...
                name_component8 = choice(Dragonborn.nm6)
                name_component9 = choice(Dragonborn.nm9)
