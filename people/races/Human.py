...
class Human(Person):
    ...
    def nameSur(self):
        if i < 2:
            name_component = choice(Human.nm9)
            name_component2 = choice(Human.nm10)
            name_component3 = choice(Human.nm11)
            name_component4 = choice(Human.nm10)
            name_component5 = choice(Human.nm12)
            lname = name_component + name_component2 + name_component3 + name_component4 + name_component5
        elif i < 4:
            name_component = choice(Human.nm21)
            name_component2 = choice(Human.nm22)
            while name_component == name_component2:
                name_component2 = choice(Human.nm22)

            lname = name_component + name_component2
        elif i < 6:
            name_component = choice(Human.nm30)
            name_component2 = choice(Human.nm31)
            name_component5 = choice(Human.nm33)
            if i == 4:
                lname = name_component + name_component2 + name_component5
            else:
                name_component3 = choice(Human.nm32)
                name_component4 = choice(Human.nm31)
                lname = name_component + name_component2 + name_component3 + name_component4 + name_component5
			...
			name_component = choice(Human.nm50)
			name_component2 = choice(Human.nm51)
			name_component3 = choice(Human.nm52)
			name_component4 = choice(Human.nm51)
			name_component5 = choice(Human.nm53)
			if i == 8:
				name_component6 = choice(Human.nm52)
				name_component7 = choice(Human.nm51)
				lname = name_component + name_component2 + name_component3 + name_component4 + name_component6 + name_component7 + name_component5
			else:
				lname = name_component + name_component2 + name_component3 + name_component4 + name_component5

		elif i < 12:
			name_component = choice(Human.nm62)
			name_component2 = choice(Human.nm63)
			name_component3 = choice(Human.nm64)
			name_component4 = choice(Human.nm63)
			name_component5 = choice(Human.nm64)
			name_component6 = choice(Human.nm63)
			if i == 10:
				name_component7 = choice(Human.nm64)
				name_component8 = choice(Human.nm63)
			...
			name_component = choice(Human.nm70)
			name_component2 = choice(Human.nm71)
			name_component3 = choice(Human.nm72)
			...
			name_component = choice(Human.nm80)
			name_component2 = choice(Human.nm14)
			name_component3 = choice(Human.nm81)
			name_component4 = choice(Human.nm14)
			name_component6 = choice(Human.nm81)
			name_component7 = choice(Human.nm14)
			name_component5 = choice(Human.nm82)
			lname = name_component + name_component2 + name_component3 + name_component4 + name_component6 + name_component7 + name_component5
	...
	def nameFem(self):
		if i < 2:
			name_component = choice(Human.nm5)
			name_component2 = choice(Human.nm6)
			name_component3 = choice(Human.nm7)
			name_component4 = choice(Human.nm6)
			name_component5 = choice(Human.nm8)
			if i == 0:
				name_component6 = choice(Human.nm7)
				name_component7 = choice(Human.nm6)
			...
			name_component = choice(Human.nm17)
			name_component2 = choice(Human.nm18)
			name_component3 = choice(Human.nm19)
			name_component4 = choice(Human.nm18)
			name_component5 = choice(Human.nm20)
			if i == 2:
				name_component6 = choice(Human.nm19)
				name_component7 = choice(Human.nm18)
				nMs = name_component + name_component2 + name_component3 + name_component4 + name_component6 + name_component7 + name_component5
			...
			name_component = choice(Human.nm27)
			name_component2 = choice(Human.nm24)
			name_component5 = choice(Human.nm29)
			if i == 4:
				name_component3 = choice(Human.nm28)
				name_component4 = choice(Human.nm24)
				nMs = name_component + name_component2 + name_component3 + name_component4 + name_component5
			else:
				nMs = name_component + name_component2 + name_component5

		elif i < 8:
			name_component = choice(Human.nm38)
			name_component2 = choice(Human.nm24)
			name_component3 = choice(Human.nm39)
			name_component4 = choice(Human.nm24)
			name_component5 = choice(Human.nm40)
			if i == 6:
				name_component6 = choice(Human.nm39)
				name_component7 = choice(Human.nm24)
				nMs = name_component + name_component2 + name_component3 + name_component4 + name_component6 + name_component7 + name_component5
			else:
				nMs = name_component + name_component2 + name_component3 + name_component4 + name_component5

		elif i < 10:
			name_component = choice(Human.nm47)
			name_component2 = choice(Human.nm14)
			name_component3 = choice(Human.nm48)
			name_component4 = choice(Human.nm14)
			name_component5 = choice(Human.nm49)
			if i == 8:
				name_component6 = choice(Human.nm48)
				name_component7 = choice(Human.nm14)
				nMs = name_component + name_component2 + name_component3 + name_component4 + name_component6 + name_component7 + name_component5
			else:
				nMs = name_component + name_component2 + name_component3 + name_component4 + name_component5
			...
			name_component = choice(Human.nm58)
			name_component2 = choice(Human.nm59)
			name_component3 = choice(Human.nm60)
			name_component4 = choice(Human.nm59)
			name_component5 = choice(Human.nm61)
			if i == 10:
				name_component6 = choice(Human.nm60)
				name_component7 = choice(Human.nm59)
				nMs = name_component + name_component2 + name_component3 + name_component4 + name_component6 + name_component7 + name_component5
			else:
				nMs = name_component + name_component2 + name_component3 + name_component4 + name_component5

		elif i < 14:
			# name_component = choice(Human.nm68)
			# name_component2 = choice(Human.nm69)
			# nMs = name_component + name_component2
			# else:
			name_component = choice(Human.nm77)
			name_component2 = choice(Human.nm78)
			name_component3 = choice(Human.nm79)
			name_component4 = choice(Human.nm77)
			if i == 12:
				name_component6 = choice(Human.nm79)
				name_component7 = choice(Human.nm77)
	...
	def nameMas(self, i):
		if i < 2:
			name_component = choice(Human.nm1)
			name_component2 = choice(Human.nm2)
			name_component3 = choice(Human.nm3)
			name_component4 = choice(Human.nm2)
			name_component5 = choice(Human.nm4)
			nMs = name_component + name_component2 + name_component3 + name_component4 + name_component5
		elif i < 4:
			name_component = choice(Human.nm13)
			name_component2 = choice(Human.nm14)
			name_component3 = choice(Human.nm15)
			name_component4 = choice(Human.nm14)
			name_component5 = choice(Human.nm16)
			...
			name_component = choice(Human.nm23)
			name_component2 = choice(Human.nm24)
			name_component5 = choice(Human.nm26)
			if i == 4:
				name_component3 = choice(Human.nm25)
				name_component4 = choice(Human.nm24)
				nMs = name_component + name_component2 + name_component3 + name_component4 + name_component5
			...
			name_component = choice(Human.nm34)
			name_component2 = choice(Human.nm35)
			name_component5 = choice(Human.nm37)
			if i == 6:
				name_component3 = choice(Human.nm36)
				name_component4 = choice(Human.nm35)
				nMs = name_component + name_component2 + name_component3 + name_component4 + name_component5
			else:
				nMs = name_component + name_component2 + name_component5

		elif i < 10:
			name_component = choice(Human.nm43)
			name_component2 = choice(Human.nm44)
			name_component3 = choice(Human.nm45)
			name_component4 = choice(Human.nm44)
			name_component5 = choice(Human.nm46)
			if i == 8:
				name_component6 = choice(Human.nm45)
				name_component7 = choice(Human.nm44)
				nMs = name_component + name_component2 + name_component3 + name_component4 + name_component6 + name_component7 + name_component5
			else:
				nMs = name_component + name_component2 + name_component3 + name_component4 + name_component5

		elif i < 12:
			name_component = choice(Human.nm54)
			name_component2 = choice(Human.nm55)
			name_component3 = choice(Human.nm56)
			name_component4 = choice(Human.nm55)
			name_component5 = choice(Human.nm57)
			if i == 10:
				name_component6 = choice(Human.nm56)
				name_component7 = choice(Human.nm55)
				nMs = name_component + name_component2 + name_component3 + name_component4 + name_component6 + name_component7 + name_component5
			else:
				nMs = name_component + name_component2 + name_component3 + name_component4 + name_component5

		elif i < 14:
			# name_component = choice(Human.nm65)
			# name_component2 = choice(Human.nm66)
			# name_component3 = choice(Human.nm67)
			# if name_component3 < 3:
			# 	while name_component < 2:
			# 		name_component = choice(Human.nm65)
			# 	nMs = name_component + name_component2 + name_component3
			# else:
			name_component = choice(Human.nm73)
			name_component2 = choice(Human.nm74)
			name_component3 = choice(Human.nm75)
			name_component4 = choice(Human.nm74)
			name_component5 = choice(Human.nm76)
			if i == 14:
				name_component6 = choice(Human.nm75)
				name_component7 = choice(Human.nm74)
				nMs = name_component + name_component2 + name_component3 + name_component4 + name_component6 + name_component7 + name_component5
			else:
				nMs = name_component + name_component2 + name_component3 + name_component4 + name_component5
